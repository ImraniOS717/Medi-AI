...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: Bundle.main.bundleIdentifier ?? "com.slickcall.app" , account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: Bundle.main.bundleIdentifier ?? "com.slickcall.app", account: "userIdentifier").deleteItem()
        } catch {
